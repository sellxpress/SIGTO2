...
{
    public partial class FrmListaProductosBo : Form
    {
        private bool buscando = false; 
        public FrmListaProductosBo()
        {
            InitializeComponent();
        ...
        private void CargarArticulos()
        {
            ...
            CalcularCantidadTotal(dgvProducto);
    }
        private void CalcularCantidadTotal(DataGridView dgvProducto)
        {
            int totalCantidad = 0;
            ...
            lblCantidad.Text = $"Productos: {totalCantidad}";
        }
        ...
        private void btnDetalles_Click(object sender, EventArgs e)
        {
            if (dgvProducto.SelectedRows.Count > 0)
            {
                ...
                this.Close();
                FrmProductosBO form = new FrmProductosBO(articuloSeleccionado);
                form.Show();
            }
            else
            {
